            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-sm">
                    <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-slate-800">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-slate-100">Edit Profil & Informasi Pasien</h2>
                            <p className="text-xs text-slate-400">Perbarui data kontak, kondisi medis, dan status keaktifan pasien.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <div>
                            ...
                            {errors.is_active && <span className="text-xs text-rose-400 mt-1 block">{errors.is_active}</span>}
                        </div>
