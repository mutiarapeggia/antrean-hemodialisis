            ...
            <div className="max-w-3xl mx-auto">
                ...
                <div className="bg-slate-900 border border-slate-800 rounded-2xl p-6 sm:p-8 shadow-sm">
                    <div className="flex items-center space-x-3 mb-6 pb-4 border-b border-slate-800">
                        ...
                        <div>
                            <h2 className="text-lg font-bold text-slate-100">Form Data Pasien Baru</h2>
                            <p className="text-xs text-slate-400">Isi data lengkap pasien untuk pendaftaran dan pembuatan akun login.</p>
                        </div>
                    </div>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500"
                                />
                            ...
                            <div>
                                <label className="block text-xs font-semibold text-slate-300 uppercase tracking-wider mb-2">
                                    Nomor Rekam Medis (RM) <span className="text-rose-400">*</span>
                                </label>
                                <input
                                    type="text"
                                    value={data.medical_record_number}
                                    onChange={(e) => setData('medical_record_number', e.target.value)}
                                    className="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-blue-400 font-mono font-semibold focus:outline-none focus:border-blue-500"
                                />
                                {errors.medical_record_number && <span className="text-xs text-rose-400 mt-1 block">{errors.medical_record_number}</span>}
                            </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-blue-500"
                            ></textarea>
                            {errors.address && <span className="text-xs text-rose-400 mt-1 block">{errors.address}</span>}
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                className="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-slate-100 placeholder-slate-500 focus:outline-none focus:border-blue-500"
                            ></textarea>
                            {errors.medical_conditions && <span className="text-xs text-rose-400 mt-1 block">{errors.medical_conditions}</span>}
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className="w-full px-4 py-2.5 bg-slate-950 border border-slate-800 rounded-xl text-sm text-slate-100 font-mono focus:outline-none focus:border-blue-500"
                            />
                            <p className="text-[11px] text-slate-500 mt-1">Default password diset ke <code className="text-blue-400">password123</code> jika tidak diubah.</p>
                        ...
                        <div className="flex justify-end space-x-3 pt-6 border-t border-slate-800">
                            ...
                            <button
                                type="submit"
                                disabled={processing}
                                className="inline-flex items-center space-x-2 px-6 py-2.5 bg-blue-600 hover:bg-blue-500 text-white text-sm font-semibold rounded-xl transition-all shadow-lg shadow-blue-600/30 disabled:opacity-50"
                            >
